...
{
    [SerializeField] private Vector3 _startCenterPos;
    [SerializeField] private float _rotateRadius, _rotateSpeed, _moveSpeed;
    ...
    [SerializeField] private AudioClip _moveClip, _pointClip, _loseClip;
	...
	private void FixedUpdate()
	{
		...
		{
            // °øÀü
            rotateAngle += _rotateSpeed * Time.deltaTime;
            moveDirection = new Vector3(Mathf.Cos(rotateAngle * Mathf.Deg2Rad), Mathf.Sin(rotateAngle * Mathf.Deg2Rad), 0f).normalized;
