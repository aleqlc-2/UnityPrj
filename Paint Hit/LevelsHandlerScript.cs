...
public class LevelsHandlerScript : MonoBehaviour
{
    ...
    public void MakeHurdles1()
    {
        ...
        gameObject.transform.GetChild(index).gameObject.GetComponent<MeshRenderer>().material.color = Color.red;
    ...
    public void MakeHurdles2()
    {
        ...
        for (int i = 0; i < array.Length; i++)
        {
            ...
            gameObject.transform.GetChild(array[i]).gameObject.GetComponent<MeshRenderer>().material.color = Color.red;
    ...
    public void MakeHurdles3()
    {
        ...
        int[] array = new int[] { Random.Range(1, 3), Random.Range(4, 6), Random.Range(18, 20) };
