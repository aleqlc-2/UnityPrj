...
public class RespawnHandler : NetworkBehaviour
{
	...
	{
		int keptCoins = (int)(player.Wallet.TotalCoins.Value * (keptCoinPercentage / 100)); // 리스폰될때 코인을 줄임
	...
	private IEnumerator RespawnPlayer(ulong ownerClientId, int keptCoins)
	{
		...
		playerInstance.Wallet.TotalCoins.Value += keptCoins; // NetworkVariable변수값을 변경하는 코드를 spawn코드 아래에 해야함
	}
}
