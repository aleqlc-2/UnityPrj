...
public class NetworkServer : IDisposable
{
	...
	{
		string payload = System.Text.Encoding.UTF8.GetString(request.Payload); // 전송되는 데이터
        ...
        _ = SpawnPlayerDelayed(request.ClientNetworkId); // Task반환이라 Task변수에 할당해야하는데 불필요한 할당이므로 _키워드변수로 무시
