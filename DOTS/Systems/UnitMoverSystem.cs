...
partial struct UnitMoverSystem : ISystem
{
   ...
   //                                                      SystemAPI.Time.DeltaTime * unitMover.ValueRO.rotationSpeed);
			...
			//// PhysicsVelocity써야 unitMover변경값이 적용됨
			//// localTransform.ValueRW.Position += moveDirection + unitMover.ValueRO.moveSpeed * SystemAPI.Time.DeltaTime; // 이렇게하면 적용안됨
