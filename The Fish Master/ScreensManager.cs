...
public class ScreensManager : MonoBehaviour
{
    ...
    void Awake()
    {
        if (ScreensManager.instance) Destroy(base.gameObject);
        else ScreensManager.instance = this;
    ...
    public void CheckIdles()
    {
        ...
        if (wallet < lengthCost)lengthButton.interactable = false;
        ...
        if (wallet < offlineEarningsCost) offlineButton.interactable = false;
