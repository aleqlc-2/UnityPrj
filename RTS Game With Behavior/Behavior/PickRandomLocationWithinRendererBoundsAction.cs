...
namespace GameDevTV.RTS.Behavior
{
	...
	[NodeDescription(name: "PickRandomLocationWithinRendererBounds", story: "Set [TargetLocation] to a random point within [BuildingUnderConstruction] .", category: "Action", id: "43ae851bf9a236fa55a1985c4105ceba")]
	public partial class PickRandomLocationWithinRendererBoundsAction : Action
	{
		...
		protected override Status OnStart()
		{
			...
			TargetLocation.Value = new Vector3(UnityEngine.Random.Range(bounds.min.x, bounds.max.x),
